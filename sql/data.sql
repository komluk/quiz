...
INSERT INTO `answers` (`id`, `question_id`, `value`, `correct`, `points`) VALUES
(1, 1, '$DOMAIN', 0,0),
(2, 1, '$GLOBALS', 0,0),
(3, 1, '$_ENV', 0,0),
(4, 1, '$REMOTE_ADDR', 1,10),
(5, 2, '< input name= MyArray[]/>', 0,0),
(6, 2, '< input ="MyArray[]" />', 0,0),
(7, 2, '< input name="MyArray[]" />', 1,10),
(8, 2, '< input MyArray[] />', 0,0),
(9, 3, 'const', 0,0),
(10, 3, 'constant', 0,0),
(11, 3, 'define', 1,10),
(12, 3, '#pragma', 0,0),
...
(20, 5, 'Zarówno b, jak i c powyżej', 0,0),
(21, 6, 'Znajdź ostatni znak łańcucha', 0,0),
(22, 6, 'Zarówno b, jak i c', 0,0),
(23, 6, 'Wyszukiwanie znaku w ciągu znaków', 1,10),
(24, 6, 'Zlokalizuj pozycję pierwszego znaku łańcucha', 0,0),
(25, 7, '!=', 0,0),
(26, 7, '>=', 0,0),
(27, 7, '<=>', 1,10),
(28, 7, '<>', 0,0),
...
(30, 8, 'header()', 1,10),
(31, 8, 'reflect()', 0,0),
(32, 8, 'Żaden z powyższych', 0,0),
(33, 9, 'setcookie()', 1,10),
(34, 9, '$_COOKIE', 0,0),
(35, 9, '$HTTP_COOKIE_VARS', 0,0),
(36, 9, 'isset() ', 0,0),
(37, 10, "$_FILES['file']['error']", 0,0),
(38, 10, "$_FILES['file']['name']", 0,0),
(39, 10, "$_FILES['file']['size']", 0,0),
(40, 10, "$_FILES['file']['type']", 0,0),
(41, 11, 'Funkcje', 0,0),
(42, 11, 'Plik', 1,10),
(43, 11, 'Udostępnianie pliku', 0,0),
(44, 11, 'Data', 0,0),
(45, 12, '< script=’java’>', 0,0),
(46, 12, '< javascript>', 0,0),
(47, 12, '< script>', 1,10),
(48, 12, '< js>', 0,0),
(49, 13, '&', 0,0),
(50, 13, '\\', 1,10),
(51, 13, '-', 0,0),
(52, 13, '%', 0,0),
(53, 14, 'var txt = new Array(1:"xyz",2:"abc",3:"asd")', 0,0),
(54, 14, 'var txt = new Array:1=(" xyz ")2=("abc")3=("asd")', 0,0),
(55, 14, 'var txt = new Array("xyz ","abc","asd")', 1,10),
(56, 14, 'var txt = new Array=" xyz ","abc","asd"', 0,0),
(57, 15, 'System.out.println(“Hello World”)', 0,0),
(58, 15, 'print(“Hello World”)', 0,0),
(59, 15, 'document.write(“Hello World”)', 1,10),
(60, 15, 'response.write(“Hello World”)', 0,0),
(61, 16, 'visibilty', 1,10),
(62, 16, 'visible', 0,0),
(63, 16, 'invisibility', 0,0),
(64, 16, 'invisible', 0,0),
(65, 17, 'new Date(dateString)', 0,0),
(66, 17, 'new Date()', 0,0),
(67, 17, 'new Date(seconds)', 1,10),
(68, 17, 'new Date(year, month, day, hours, minutes, seconds, milliseconds)', 0,0),
(69, 18, 'HTML', 0,0),
(70, 18, 'CSS', 0,0),
(71, 18, 'XML', 0,0),
...
(80, 20, 'Użycie atrybutu rs', 0,0),
(81, 21, 'Użycie &', 0,0),
(82, 21, 'Użycie $', 0,0),
(83, 21, 'Użycie *', 1,10),
(84, 21, 'Użycie #', 0,0),
(85, 22, 'jednej sesji', 1,10),
...
(102, 26, 'Trzy', 0,0),
(103, 26, 'Cztery', 0,0),
(104, 26, 'Żaden z nich', 0,0),
(105, 27, '.serialize() ', 1,10),
(106, 27, '.serializeAll()', 0,0),
(107, 27, '.synchronized()', 0,0),
(108, 27, 'Żaden z nich', 0,0),
(109, 28, 'getMessage()', 0,0),
(110, 28, 'getCode()', 0,0),
(111, 28, 'getFile()', 1,10),
(112, 28, 'getLine()', 0,0),
(113, 29, 'mysql_connect()', 0,0),
(114, 29, 'mysql_query()', 0,0),
(115, 29, 'mysql_close()', 1,10),
(116, 29, 'Żaden z powyższych', 0,0),
(117, 30, 'link', 0,0),
(118, 30, 'ref', 0,0),
(119, 30, 'href', 1,10),
(120, 30, 'newref', 0,0);
